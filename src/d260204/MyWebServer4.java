	...
	public static void main(String[] args) {
		try(ServerSocket server=new ServerSocket(8888)){
			...
			if(data.startsWith("GET")) {
				...
				FileInputStream fis
				=new FileInputStream("E:/work/java/workspace/d260121/src/d260204/upload.html");
				...
				*/
                ...
                System.out.println("파일에 쓸 데이터:"+new String(Arrays.copyOfRange(body, start, body.length-boundary.length())));    
