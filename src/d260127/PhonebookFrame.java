...
public class PhonebookFrame extends Frame{
	...
	public PhonebookFrame() {
		...
		deleteActionBtn.setBackground(Color.GRAY);
		deleteActionBtn.setVisible(false);
		add(deleteActionBtn);
		...
		menuDeletebtn.addActionListener(new ActionListener() {
		    ...
		    public void actionPerformed(ActionEvent e) {
		        ...
		        listBox.removeAll(); 
		        for(Phonebook p : pm.getList()) {
		            listBox.add(p.getId() + " " + p.getName() + " " + p.getHp());
		        }
		...
		deleteActionBtn.addActionListener(new ActionListener() {
		    ...
		    public void actionPerformed(ActionEvent e) {
		        ...
		        viewIdlb.setText("아이디:");
		        viewNamelb.setText("이름:");
		        viewHplb.setText("전화번호:");
		        viewEmaillb.setText("이메일:");
	...
	public void refreshListBox(java.awt.List listBox) {
	    listBox.removeAll(); 
	    for (Phonebook p : pm.getList()) {
	        listBox.add(p.getId() + " " + p.getName() + " " + p.getHp());
	    }
